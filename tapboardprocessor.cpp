...
int TapboardProcessor::processRawFile(QString &rawFileName)
{
    ...
    rawFile.setFileName(rawFileName);
    ...
    progressWindow = new QProgressDialog("Importing raw SD trace…", "Cancel", 0, 3);
    ...
    QFile sortedFile;
    sortedFile.setFileName(fileName);
    ...
    qDebug() << "Joined file:" << joinedFile.fileName();
    qDebug() << "Grouped file:" << groupedFile.fileName();
    qDebug() << "Sorted file:" << sortedFile.fileName();
